...
class SQLIsolationExecutor(object):
    ...
    class SQLSessionProcess(object):
        ...
        def get_hostname_port(self, contentid, role):
            ...
            raise Exception("Cannot get the hostname and port of the segment: content {}, role: {}".format(contentid, role))
    ...
    def get_all_primary_contentids(self, dbname):
        ...
        raise Exception("Cannot fetch all primary content ids")
